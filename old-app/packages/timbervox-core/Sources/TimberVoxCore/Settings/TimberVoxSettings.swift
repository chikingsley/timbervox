...
public struct TimberVoxSettings: Codable, Equatable, Sendable {
  public static let defaultPasteLastTranscriptHotkey: HotKey? = nil
  ...
  public static var defaultPasteLastTranscriptHotkeyDescription: String {
    guard let defaultPasteLastTranscriptHotkey else { return "Unset" }
  ...
  public var realtimeTranscriptionEnabled: Bool
  ...
  public init(
    ...
    realtimeTranscriptionEnabled: Bool = false,
