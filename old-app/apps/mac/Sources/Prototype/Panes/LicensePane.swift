...
struct LicensePane: View {
  ...
  private var licenseCard: some View {
    VStack(alignment: .leading, spacing: LicensePaneMetrics.stackSpacing) {
      HStack(spacing: LicensePaneMetrics.brandSpacing) {
        ...
        Text(LicensePaneCopy.proBadge)
          ...
          .background(Theme.chipSurface, in: RoundedRectangle(cornerRadius: LicensePaneMetrics.badgeCornerRadius))
        InfoHint(LicensePaneCopy.proHint)
      }
    ...
    .background(Theme.cardSurface, in: RoundedRectangle(cornerRadius: LicensePaneMetrics.cardCornerRadius))
  }
    ...
    HStack(spacing: LicensePaneMetrics.actionSpacing) {
      if isPro {
        ...
        Button {
          ...
          Text(LicensePaneCopy.activateButton)
            ...
            .overlay(
              RoundedRectangle(cornerRadius: LicensePaneMetrics.buttonCornerRadius)
                .strokeBorder(Color.primary.opacity(LicensePaneMetrics.buttonStrokeOpacity), lineWidth: LicensePaneMetrics.strokeWidth)
            )
        }
        .buttonStyle(.plain)
        ...
        Button {
          ...
          Text(LicensePaneCopy.purchaseButton)
            ...
            .padding(.horizontal, LicensePaneMetrics.buttonHorizontalPadding)
            .frame(height: LicensePaneMetrics.buttonHeight)
            .background(Theme.accentGreen, in: RoundedRectangle(cornerRadius: LicensePaneMetrics.buttonCornerRadius))
        }
        .buttonStyle(.plain)
  ...
  private var activeLicensePill: some View {
    Label(LicensePaneCopy.licenseActiveButton, systemImage: LicensePaneIcons.active)
      .font(.system(size: LicensePaneMetrics.buttonFontSize, weight: .semibold))
      .padding(.horizontal, LicensePaneMetrics.buttonHorizontalPadding)
      .frame(height: LicensePaneMetrics.buttonHeight)
      .background(
        Color.primary.opacity(LicensePaneMetrics.activeButtonOpacity), in: RoundedRectangle(cornerRadius: LicensePaneMetrics.buttonCornerRadius)
      )
      .overlay(
        RoundedRectangle(cornerRadius: LicensePaneMetrics.buttonCornerRadius)
          .strokeBorder(Color.primary.opacity(LicensePaneMetrics.activeButtonStrokeOpacity), lineWidth: LicensePaneMetrics.strokeWidth)
      )
  }
  ...
  private var promoCard: some View {
    ...
    .overlay(
      RoundedRectangle(cornerRadius: LicensePaneMetrics.cardCornerRadius)
        .strokeBorder(Theme.borderStroke, lineWidth: LicensePaneMetrics.strokeWidth)
    )
  }
}
...
private struct LicenseLinkPill: View {
  ...
  var body: some View {
    Button {
      ...
      .background(
        hovering ? Theme.hoverFill : Theme.cardSurface,
