...
struct PrototypeDictionaryPaneV2: View {
  ...
  var body: some View {
    ZStack(alignment: .trailing) {
      VStack(spacing: 0) {
        Header {
          SearchField(placeholder: "Search vocabulary", text: $searchText)
      ...
      VStack(alignment: .leading, spacing: 12) {
        ...
        .overlay(
          RoundedRectangle(cornerRadius: 10)
            .strokeBorder(Theme.borderStroke, style: StrokeStyle(lineWidth: 1.5, dash: [5, 4]))
        )
        .contentShape(Rectangle())
        ...
        VStack(spacing: 10) {
          Button {
            ...
            Text("Save")
              ...
              .frame(maxWidth: .infinity)
              .frame(height: 36)
              .background(Theme.accentBlue, in: RoundedRectangle(cornerRadius: 9))
              .contentShape(Rectangle())
          }
          .buttonStyle(.plain)
        ...
        if hovering {
          Button(action: delete) {
            Image(systemName: "xmark")
              ...
              .background(Theme.fieldSurface, in: RoundedRectangle(cornerRadius: 6))
              .contentShape(Rectangle())
          }
          .buttonStyle(.plain)
          .help("Remove")
