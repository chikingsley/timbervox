...
enum Theme {
  ...
  static let sidebarBackground = Color(lightHex: 0xE8E8E8, darkHex: Shadcn.neutral900)
  static let cardSurface = Color(lightHex: 0xFFFFFF, darkHex: Shadcn.neutral800)
